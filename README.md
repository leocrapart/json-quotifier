...
```
cd existing_repo
git remote add origin https://gitlab.com/leocrapart/double-quote-json2single-quote-json.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/leocrapart/double-quote-json2single-quote-json/-/settings/integrations)
